...
| Post-Stage knowledge/portability domains    | Stage 12 implemented; Stage 13 core complete | Stage 12 portability/recordings workflows are implemented in admin runtime routes and schema: [backend/src/api/admin.routes.ts](backend/src/api/admin.routes.ts), [backend/src/services/admin-portability.service.ts](backend/src/services/admin-portability.service.ts), [backend/prisma/schema.prisma](backend/prisma/schema.prisma), [admin/src/pages/CampaignManagement.tsx](admin/src/pages/CampaignManagement.tsx), [admin/src/pages/Settings.tsx](admin/src/pages/Settings.tsx). Stage 13 core guest-auth and external-identity flows are implemented in the main runtime; extension bridge continuation is tracked in [docs/extension/EXTENSION-ROADMAP.md](docs/extension/EXTENSION-ROADMAP.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
