...
export function UserFilters({
  ...
  return (
    <div className="admin-toolbar-row wrap">
      ...
      />
      <select aria-label="Filter by role" value={roleFilter} onChange={(event) => onRoleFilterChange(event.target.value)}>
      ...
      <select aria-label="Rows per page" value={String(pageSize)} onChange={(event) => onPageSizeChange(Number(event.target.value))}>
