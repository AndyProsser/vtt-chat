...
function makeBundle(): CampaignTransferBundle {
  return {
    ...
    campaign: {
      ...
      settings: {
        discoverable: false,
        spectatorPolicy: 'NONE' as const,
        spectatorMax: null,
        spectatorWaitlistEnabled: false,
        spectatorReconnectGraceSecs: 60,
        extensionSyncPolicy: 'DM_AND_PLAYERS' as const,
        lateJoinPolicy: 'OPEN' as const,
      ...
      members: [
        {
          userId: 'dm-1',
          role: 'DM',
          user: { id: 'dm-1', username: 'dm-user', displayName: 'DM', role: 'DM', email: null },
        },
      ],
      characters: [],
      notes: [],
