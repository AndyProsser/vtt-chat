...
export const AUDIO_SETTINGS_COPY = {
  ...
  backgroundAudioLevel: 'Background Audio Level',
  backgroundAudioLevelAria: 'Background audio level',
  backgroundAudioLevelWhisperHint: 'Whisper mode caps background audio output at 20%.',
