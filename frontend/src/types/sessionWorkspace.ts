...
export type SessionWorkspaceProps = {
  ...
  characterDraft: ComponentProps<typeof SessionSettingsPanel>['characterDraft']
  onCharacterFieldChange: ComponentProps<typeof SessionSettingsPanel>['onCharacterFieldChange']
