...
function areSameParticipants(
  ...
  for (let index = 0; index < previous.length; index += 1) {
    if (!areSameParticipant(previous[index], next[index])) {
      return false
    }
  }
...
function areGroupCardPropsEqual(previous: GroupCardProps, next: GroupCardProps): boolean {
  return (
...
function RoomGroupCardComponent({
  room,
  selected,
  participants,
  sessionId,
...
export const RoomGroupCard = memo(RoomGroupCardComponent, areGroupCardPropsEqual)
