  ...
  const sessionWorkspaceProps = useMemo(
    () =>
      buildSessionWorkspaceProps({
        ...
        toolbarStatusColorKey: connectionStatus.statusColorKey,
        toolbarStatusLabel: connectionStatus.label,
        toolbarCoreWsState: connectionStatus.coreWsState,
        toolbarLivekitState: connectionStatus.livekitState,
    ...
    [
      ...
      connectionStatus.statusColorKey,
      user,
      wsRetrySecondsRemaining,
      wsState,
    ]
