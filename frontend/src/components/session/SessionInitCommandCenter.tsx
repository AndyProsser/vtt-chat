...
import { CampaignInformationPanel } from '../shared/CampaignInformationPanel'
import { CampaignRightbarSettings } from '../editor/CampaignRightbarSettings'
...
type SessionInitCommandCenterProps = {
...
export function SessionInitCommandCenter(props: SessionInitCommandCenterProps) {
