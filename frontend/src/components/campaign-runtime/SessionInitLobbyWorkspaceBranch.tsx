...
import { toValidPostSessionDurationMinutes } from './sessionInit.utils'
import { CampaignRightbarSettings, type CharacterSettingsDraft } from '../campaign-editor/CampaignRightbarSettings'
import { LobbyCampaignSettingsPanel } from '../lobby/LobbyCampaignSettingsPanel'
import { LobbyCampaignWorkspaceView } from '../lobby/LobbyCampaignWorkspaceView'
import type { CampaignSettingsPayload, CampaignSummary } from './sessionInit.shared'

type SessionInitLobbyWorkspaceBranchProps = {
...
export function SessionInitLobbyWorkspaceBranch(props: SessionInitLobbyWorkspaceBranchProps) {
  ...
  return (
    <LobbyCampaignWorkspaceView
      ...
      canEditCampaignInfo={Boolean(props.selectedCampaign && props.selectedCampaign.currentDmId === props.userId)}
      isLaunchDisabled={props.isLaunchDisabled}
      launchDisabledReason={props.launchDisabledReason}
      showInviteWidget={Boolean(props.selectedCampaign && props.selectedCampaign.currentDmId === props.userId)}
      joinUrl={
