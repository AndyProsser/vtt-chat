...
import { AudioPresetsPanel } from '../../components/audio/AudioPresetsPanel'
import { AudioEffectsPanel } from '../../components/audio/AudioEffectsPanel'
import { AudioDMOverridesPanel } from '../../components/audio/AudioDMOverridesPanel'
...
describe('AudioPanel subcomponents', () => {
  ...
  it('renders DM override panel for DMs only', () => {
    const overrides = new Map<UUID, AudioDMOverride>()
    overrides.set('11111111-1111-4111-8111-111111111111' as UUID, {
