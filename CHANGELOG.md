...
- W11 runtime route classification baseline:
  ...
  - Expanded registry coverage to `chat` and `notes` mutation surfaces in addition to `presence`, `rooms`, `audio`, and `session`.
...
- State-machine documentation was reconciled with the implemented lifecycle:
  ...
  - Added W11 convergence snapshot: `docs/changes/W11-REDIS-FIRST-AUDIT-2026-05-18.md`.
