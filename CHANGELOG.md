...
- Frontend settings panel consolidation (2026-05-23):
  ...
  - Moved session-only settings UI out of shared panels into `frontend/src/components/workspaces/session/SessionSettingsPanel.tsx`.
  - Moved editor settings wrapper out of shared panels into `frontend/src/components/workspaces/editor/EditorSettingsPanel.tsx`.
