...
export type NotesEventType = 'NOTES:CREATED' | 'NOTES:UPDATED' | 'NOTES:DELETED' | 'NOTES:SHARED' | 'NOTES:TAG_ADDED';
export type AudioEventType = 'AUDIO:EFFECT_APPLIED' | 'AUDIO:EFFECT_REMOVED' | 'AUDIO:PRESET_LOADED' | 'AUDIO:ENVIRONMENT_SET' | 'AUDIO:DM_OVERRIDE_APPLIED' | 'AUDIO:DM_OVERRIDE_REMOVED';
/**
 * NOTES:CREATED
 ...
 * Union types.
 */
export type NotesEvent = NotesCreatedEvent | NotesUpdatedEvent | NotesDeletedEvent | NotesSharedEvent | NotesTagAddedEvent;
export type AudioEvent = AudioEffectAppliedEvent | AudioEffectRemovedEvent | AudioPresetLoadedEvent | AudioEnvironmentSetEvent | AudioDMOverrideAppliedEvent | AudioDMOverrideRemovedEvent;
