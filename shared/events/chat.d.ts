...
export type ChatEventType = 'CHAT:MESSAGE_SENT' | 'CHAT:MESSAGE_EDITED' | 'CHAT:MESSAGE_DELETED' | 'CHAT:TYPING_STARTED' | 'CHAT:TYPING_STOPPED';
/**
 * CHAT:MESSAGE_SENT
 ...
 */
export type ChatEvent = ChatMessageSentEvent | ChatMessageEditedEvent | ChatMessageDeletedEvent | ChatTypingStartedEvent | ChatTypingStoppedEvent;
