...
export type SessionEventType = 'SESSION:CREATED' | 'SESSION:STARTED' | 'SESSION:PAUSED' | 'SESSION:RESUMED' | 'SESSION:ENDED' | 'SESSION:ARCHIVED';
/**
 * SESSION:CREATED
 ...
 */
export type SessionEvent = SessionCreatedEvent | SessionStartedEvent | SessionPausedEvent | SessionResumedEvent | SessionEndedEvent | SessionArchivedEvent;
